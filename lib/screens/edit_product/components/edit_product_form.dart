...
import 'package:commerce_hub/exceptions/local_files_handling/image_picking_exceptions.dart';
import 'package:commerce_hub/exceptions/local_files_handling/local_file_handling_exception.dart';
...
class _EditProductFormState extends State<EditProductForm> {
  ...
  Widget buildDescriptionField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText:
            "e.g., This a phone made in South Korea, by Samsung. With this device, Samsung introduces its new F Series.",
  ...
  Widget buildLocationField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.name,
      decoration: InputDecoration(
        hintText: "e.g., Naraguta, Lamingo, Hostel, Ring Road...",
        labelText: "Location",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (_) {
