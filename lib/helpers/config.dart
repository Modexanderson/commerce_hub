...
class MyTheme with ChangeNotifier {
  ...
  void refresh() {
    ...
    accentColor = settingsBox.get('themeColor', defaultValue: 'Indigo') as String;
    canvasColor =
  ...
  Color getColor(String color, int hue) {
    switch (color) {
      ...
      default:
        return _isDark ? Colors.indigoAccent[400]! : Colors.indigoAccent[400]!;
    }
  }
  ...
  Color currentColor() {
    switch (accentColor) {
      ...
      default:
        return _isDark ? Colors.indigoAccent[400]! : Colors.indigo[400]!;
    }
  }
